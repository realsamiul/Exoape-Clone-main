...
const Hero = memo(({
  ...
  return (
    <motion.div
      ...
      id="hero"
      className="main relative w-full h-[200vh] will-change-transform"
    >
      <div className="picture w-full h-full overflow-hidden bg-black">
        <img 
          className="w-full h-[270vh] object-cover will-change-transform" 
          src={HeroBG} 
          alt="Hero background showing digital design experience"
          loading="eager"
          decoding="async"
        />
      </div>
      ...
      <div className="absolute w-full top-0 left-0">
        <div className="heroTextContainer text text-white mx-auto h-full px-5 sm:px-32 will-change-transform">
          ...
          <div className="mt-20 sm:mt-32">
            ...
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mt-5 sm:mt-20 gap-5 sm:gap-0">
              <a
