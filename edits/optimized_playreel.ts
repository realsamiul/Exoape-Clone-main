...
const Playreel = memo(() => {
  ...
  return (
    ...
    >
      <div className="video-div w-48 sm:w-80 sm:h-44 h-28 absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 will-change-transform">
      ...
      <div className="overlay absolute flex flex-col justify-between w-full h-full text-[#e4e0db] py-10 sm:py-20 px-5">
        ...
        <p className="text-center text-xs sm:text-sm">
          Our work is best experienced in motion. Don't <br className="hidden sm:block" /> forget to put on
          your headphones.
        </p>
      </div>
    </div>
